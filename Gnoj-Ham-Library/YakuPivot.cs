...
public class YakuPivot
{
    ...
    /// </summary>
    public int ConcealedBonusFanCount { get; }
    /// <summary>
    ...
    /// </summary>
    public IReadOnlyList<TilePivot>? Example { get; }
    ...
    private YakuPivot(string name, string nameEn, int fanCount, string? description = null,
        int concealedBonusFanCount = 0, IReadOnlyList<TilePivot>? example = null,
        params YakuPivot[] upgrades)
    {
        Name = name;
        NameEn = nameEn;
